...
void Game(int numPlayers, int level, bool speed_run) {
    ...
    if(level < 2) {
        ...
        if(level == 0) {
            ...
            Player_1->getComponent<Script, PopoBehavior>().last_level = 22;
            if (Player_2 != nullptr) {
                Player_2->getComponent<Script, PopoBehavior>().last_level = 22;
            }
            if (Player_3 != nullptr) {
                Player_3->getComponent<Script, PopoBehavior>().last_level = 22;
            }
            if (Player_4 != nullptr) {
                Player_4->getComponent<Script, PopoBehavior>().last_level = 22;
            }
            ...
            Player_1->getComponent<Script, PopoBehavior>().last_level = 20;
            if (Player_2 != nullptr) {
                Player_2->getComponent<Script, PopoBehavior>().last_level = 20;
            }
            if (Player_3 != nullptr) {
                Player_3->getComponent<Script, PopoBehavior>().last_level = 20;
            }
            if (Player_4 != nullptr) {
                Player_4->getComponent<Script, PopoBehavior>().last_level = 20;
            }
